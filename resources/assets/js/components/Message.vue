<template>
  ...
  <div
    class="sc-message fadeUp-enter-active"
    :class="{
        emit: message.author === 'me',
        reap: message.author === 'them',
        [`sc-message${message.type}`]: true,
      }"
  >
    ...
    <span
      v-if="message.type !== 'datetime' && message.type !== 'typing' && message.type !== 'system' && message.type !== 'author'"
